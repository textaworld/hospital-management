...
const DoctorHome = () => {
  ...
  <Link to={"patientScan"} style={{ textDecoration: 'none', color: 'inherit' }}>
    <button style={{ padding: '20px', backgroundColor: '#4eacca', color: 'white', border: 'none', cursor: 'pointer', borderRadius: '7px', display: 'flex', alignItems: 'center', gap: '10px' }}>
      <TbGridScan size={36} />
...
<button onClick={handleClick} style={{ marginTop: '300px', cursor: 'pointer', color: '#f8f8f8', padding: '8px', backgroundColor: '#0f172a', borderRadius: '5px', border: '1px solid #0f172a' }}>Log out</button>
