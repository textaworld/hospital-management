...
const CreateStudent = () => {
  ...
  //   const response = await fetch("https://hospital-management-tnwh.onrender.com/api/card/createCard", {
  //     method: "POST",
  ...
  //         console.log("cardDeat", siteDetailsJson);
  //         console.log("cardDeat status", siteDetailsJson.status);
